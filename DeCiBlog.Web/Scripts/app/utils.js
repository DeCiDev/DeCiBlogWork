    ...
    function (_) {
        var hasProperties = function (obj) {
            ...
            restoreFilter = function (filterData) {
                ...
                var filterList = [
                    { raw: stored.categoryOnly, filter: filter.categoryOnly },
                    { raw: stored.searchText, filter: filter.searchText },
                    { raw: stored.year, filter: filter.year, fetch: dc.blogentries.getLocalByYear },
                    { raw: stored.yearMonth, filter: filter.yearMonth, fetch: dc.blogentries.getLocalByYearMonth },
                    { raw: stored.tag, filter: filter.tag, fetch: dc.blogentries.getLocalByTag }
                ];
