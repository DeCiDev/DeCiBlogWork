...
namespace DeCiBlog.Data.Helpers
{
    /// <summary>
    /// A maker of DeCi Blog Repositories.
    /// </summary>
    /// <remarks>
    ...
    {
        /// <summary>
        /// Return the runtime DeCi Blog repository factory functions,
        /// each one is a factory for a repository of a particular type.
        /// </summary>
        /// <remarks>
        /// MODIFY THIS METHOD TO ADD CUSTOM DeCi Blog FACTORY FUNCTIONS
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetDeCiBlogFactories()
        {
        ...
        /// <summary>
        /// Constructor that initializes with runtime DeCi Blog repository factories
        /// </summary>
        public RepositoryFactories()  
        {
            _repositoryFactories = GetDeCiBlogFactories();
        }
